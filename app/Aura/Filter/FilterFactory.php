 ...
 *
 */
namespace App\Aura\Filter;

use App\Aura\Filter\Failure\FailureCollection;
use App\Aura\Filter\Locator\SanitizeLocator;
use App\Aura\Filter\Locator\ValidateLocator;
use App\Aura\Filter\Spec\SanitizeSpec;
use App\Aura\Filter\Spec\ValidateSpec;
...
class FilterFactory
{
     ...
     *
     */
    public function newSubjectFilter($class = 'App\Aura\Filter\SubjectFilter')
    {
        return new $class(
